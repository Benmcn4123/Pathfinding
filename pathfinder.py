...
while True:
    ...
    for wall in walls:
        pygame.draw.rect(win, (0, 0, 0), (wall[0] * 10, wall[1] * 10, 10, 10))

    if path_nodes != None:
        for node in path_nodes:
            pygame.draw.rect(win, (0, 200, 0), (node[0] * 10, node[1] * 10, 10, 10))

    pygame.draw.rect(win, (200, 0, 0), (end[0] * 10, end[1] * 10, 10, 10))
    pygame.draw.rect(win, (0, 0, 200), (start[0] * 10, start[1] * 10, 10, 10))
